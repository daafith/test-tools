...
echo - a phone number that should be accepted assuming the plus is allowed, inserting the country code with leading zeros
echo +"$CC"600"$CC"4567
echo - a phone number that should be accepted assuming the 00 is allowed, inserting the country code with leading zeros
